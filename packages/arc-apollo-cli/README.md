...
arc-apollo/1.6.2 darwin-x64 node-v10.0.0
$ apollo --help [COMMAND]
USAGE
  $ apollo COMMAND
...
...
_See code: [src/commands/codegen/generate.ts](https://github.com/ArcBlock/apollo-cli/blob/v1.6.2/src/commands/codegen/generate.ts)_
...
_See code: [src/commands/queries/check.ts](https://github.com/ArcBlock/apollo-cli/blob/v1.6.2/src/commands/queries/check.ts)_
...
_See code: [src/commands/schema/check.ts](https://github.com/ArcBlock/apollo-cli/blob/v1.6.2/src/commands/schema/check.ts)_
...
_See code: [src/commands/schema/download.ts](https://github.com/ArcBlock/apollo-cli/blob/v1.6.2/src/commands/schema/download.ts)_
...
_See code: [src/commands/schema/publish.ts](https://github.com/ArcBlock/apollo-cli/blob/v1.6.2/src/commands/schema/publish.ts)_
<!-- commandsstop -->
